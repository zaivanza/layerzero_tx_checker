...
2. В папке data в текстовые файлы выписываем апи ключи от сканов. Для этог нужно зарегистрироваться (ссылки ниже) и скопировать. Одного ключа на каждый скан хватит. Увеличение ключей лишь увеличит скорость парсинга :
